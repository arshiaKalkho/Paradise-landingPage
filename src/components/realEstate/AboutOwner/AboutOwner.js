  ...
  return (
    <div className='realEstate-aboutOwner-container'>
        ...
        <div className="realEstate-about-owner">
            <h2>About Me</h2>
            <p>- I am proven business man investing in realestate project all over ontario canada, working with canadian businesses change the face of toronto. Together we can build housing for thousands and provide opportunities like never before. to checkout our projects please go below and contant me here via email<br />
